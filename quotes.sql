...
-- lyrics
-- the satuscode on row 1 determines which row to read the next lyric from
-- song statuscodes: 1 - end of song
--				     2 - current song finished, wait for permission to start the next one
